    ...
    return (
        <div className="content-container">
            <div className="create-task-form">
                <h2 className="page-title">Регистрация сертификата</h2>
                ...
                <DuplicateCheckModal
                    ...
                    itemPathPrefix="/serts"
                    title="Найдены дубликаты сертификатов"
                    description="Обнаружены сертификаты с аналогичными данными:"
                    forceLabel="Все равно зарегистрировать"
                    statusLabels={certificateStatusLabels}
                />
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="form-actions">
                        <Button variant="outlined" type="button" onClick={() => navigate('/serts')} className="cancel-btn">
                            Отмена
                        </Button>
